 ...
 */
 ...
 public class tablaregistro1  {
  ...
  buscar(nombre,hoja,columna);//invocacion del metodo buscar para ver si el cliente ya esta registrado mandamos el nombre a buacar ynla hoja donde  debe buscar
     ...
     public static void emprendedores(Scanner infu, String nombre, Sheet hoja) {
        int selec=0, descripcion=0;
        String hora="", material="";
        do {
         ...
         if(selec==1){
             ...
             descripcion=infu.nextInt();
             System.out.println(amarillo+"Horario de Curso."+reset);
             hora=leerHoras(infu);
             
             }
             else if (selec==2){
                 System.out.println("Descripcion de Ayuda para vivienda: 1-Tinaco, 2-Calentador Solar, 3-Material de Construccion"); 
                 descripcion=infu.nextInt();
                 System.out.println();
                if(descripcion==3){
